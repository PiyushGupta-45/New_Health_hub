...
class FeaturesView extends StatelessWidget {
  ...
  final List<FeatureData> quickActions = const [
    // Health Metrics (BMR/BMI)
    FeatureData(
    ...
    FeatureData(
      ...
      destination: PostureAnalysisView(), // Correctly linked
    ),
    // Personalized Goals (Placeholder destination)
    FeatureData(
      icon: Icons.check_circle_outline,
      title: 'Personalized Goals',
      subtitle: 'Set and manage your health goals.',
      iconColor: Color(0xFFFFA500),
      destination: PersonalizedGoalsView(),
    ),
    // Workout Logs (Placeholder destination)
    FeatureData(
